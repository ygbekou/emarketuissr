...
import { Wallet, WalletTrans, User, Language, WalletTransDTO, WalletDTO } from 'src/app/app.models';
...
export class AdminWalletComponent extends BaseComponent implements OnInit {
